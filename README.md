...
در **تنظیمات → تب تلگرام** می‌توانید یکپارچه‌سازی تلگرام را پیکربندی کنید:
- ثبت **توکن بات** و **Chat ID** (و افزودن **دستگاه‌های** دیگر).
- انتخاب اینکه **کدام نوع اعلان** فعال باشد و هرکدام **صدادار یا بی‌صدا**.
- تعریف **یادآوری‌ها** و دکمه‌های «ارسال پیام آزمایشی»، «ارسال وضعیت»، «تنظیم منوی بات».

این بخش‌ها **خروجی** (ارسال از مرورگر به تلگرام) هستند و بدون سرور کار می‌کنند. توکن بات یک
سِکرت است و فقط در مرورگر/درایوِ شما ذخیره می‌شود (در repo کامیت نمی‌شود).

برای **کنترل دوطرفه** (اجرای دستورها از داخل تلگرام و عملکرد منوی پایین)، سرور بات در
