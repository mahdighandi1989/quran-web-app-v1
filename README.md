...
برای **کنترل دوطرفه** (اجرای دستورها از داخل تلگرام و عملکرد دکمه‌های منوی پایین)، سرور بات در
[`server/`](./server/README.md) را اجرا و webhook را تنظیم کنید (توکن آنجا امن می‌ماند).
