---
task_id: 35538917-fed9-4ada-b824-22dcaa474348
title: تضاد default برای فیلد 'config'
type: bug_fix
priority: high
...
created_at: '2026-06-12T19:16:36.945658+00:00'
updated_at: '2026-06-12T19:33:28.985995+00:00'
---

# تضاد default برای فیلد 'config'

## Raw Idea

## 📋 شرح
فیلد `config` در `` در دو یا چند جای مختلف default value متفاوت دارد.

## 🤔 چرا مهم است
defaults متناقض باعث می‌شود رفتار سیستم به ترتیب اجرا/import وابسته شود — bug های غیرقابل reproduce.

## 🔍 جزئیات
- علت: field config has different defaults: ['None,', 'hhmm:', '[]']
---
[scan #2 at 2026-06-12T19:16:37.593838+00:00]
## 📋 شرح
...
## 🔍 جزئیات
- علت: field else has different defaults: ['f"{name}:{now}:{self._seq}"', '"امروز هنوز جلسه
...
- [ ] `config` در همه‌جا از یک منبع default می‌گیرد
...
1. گام ۱: همه جاهایی که `config` default می‌گیرد لیست کن.
...
1. `config` در همه‌جا از یک منبع default می‌گیرد _(verify: static)_
