...
updated_at: '2026-06-05T18:42:38.518044+00:00'
target_files:
...
1. کلید API هرگز در network tab مرورگر دیده نشود
2. پراکسی بک‌اند درخواست‌های AI را با کلید ذخیره‌شده در سرور ارسال کند
3. کاربران مهمان (غیرواردشده) همچنان بتوانند از AI استفاده کنند (کلید در سشن موقت)
4. هشدار موجود در AISettings حذف یا به مستندات
