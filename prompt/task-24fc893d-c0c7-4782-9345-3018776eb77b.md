...
updated_at: '2026-06-12T19:31:41.479515+00:00'
target_files:
- src/App.jsx
- src/routes.jsx
...
1. کامپوننت `AIChat` در UI قابل دسترسی باشد (مثلاً از طریق یک تب یا مسیر جدید). _(verify: ui_interaction)_
2. کاربر بتواند با `AIChat` تعامل کند و پاسخ‌های هوش مصنوعی را دریافت کند. _(verify: ui_interaction)_
3. تعاملات `AI_USE_CASE.QA` از طریق `trackAIInteraction` ثبت شوند. _(verify: ui_interaction)_
4. تست E2E یا واحد برای دسترسی و عملکرد `AIChat` اضافه شود. _(verify: backend_test)_
