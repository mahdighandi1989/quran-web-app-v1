...
updated_at: '2026-06-12T19:14:38.730744+00:00'
target_files:
- package.json
...
1. دستور `npm run generate-quran-data` فایل `src/data/quranPages.json` را با موفقیت تولید یا به‌روز کند.
2. `README.md` در صورت لزوم، دستورالعمل‌های مربوط به این اسکریپت را به‌روز کند.
