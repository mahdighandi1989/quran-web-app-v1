...
updated_at: '2026-05-29T18:42:43.230289+00:00'
target_files:
- .env.example
---
...
1. فایل .env.example در ریشه پروژه وجود داشته باشد
2. تمام متغیرهای محیطی مورد نیاز در آن ذکر شده باشند
3. .env در .gitignore اضافه شده باشد
