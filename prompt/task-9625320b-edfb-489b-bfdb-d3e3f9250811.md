...
updated_at: '2026-06-05T18:46:34.280584+00:00'
target_files:
...
1. فایل src/components/StatsUI.jsx از پروژه حذف شود
2. هیچ import شکسته‌ای در پروژه باقی نماند (npm run build موفق)
3. تست‌های موجود (npm test) پاس شوند
