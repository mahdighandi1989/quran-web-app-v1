...
updated_at: '2026-06-12T19:14:39.716376+00:00'
target_files:
...
1. فایل `tests/backend/app/tasks/test_scan_tasks.py` ایجاد شود.
2. تست‌هایی برای سناریوهای موفقیت‌آمیز پردازش اسکن اضافه شود.
3. تست‌هایی برای سناریوهای شکست (مثلاً فایل ورودی نامعتبر) اضافه شود و تأیید شود که `handle_scan_failure` فراخوانی می‌شود.
4. تست‌هایی برای اطمینان از خروجی صحیح داده‌های پردازش‌شده اضافه شود.
