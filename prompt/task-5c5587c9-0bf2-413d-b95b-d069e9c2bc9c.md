---
task_id: 5c5587c9-0bf2-413d-b95b-d069e9c2bc9c
title: 🆕 فایل جدید `EngagementNudge.test.jsx` به هیچ‌جا متصل نیست (orphan)
...
created_at: '2026-06-12T19:23:12.424317+00:00'
updated_at: '2026-06-12T19:41:07.375980+00:00'
target_files:
- src/test/EngagementNudge.test.jsx
---

# 🆕 فایل جدید `EngagementNudge.test.jsx` به هیچ‌جا متصل نیست (orphan)
...
## 🔍 جزئیات
- 📂 added: `src/test/EngagementNudge.test.jsx`
- 🔥 risk: **medium**
...
---
[scan #2 at 2026-06-12T19:23:13.260403+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `src/test/engagement.e2e.test.jsx`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
- `src/components/EngagementNudge.jsx` — `EngagementNudge.test.jsx` این فایل را import می‌کند
- `src/lib/analytics.js` — `EngagementNudge.test.jsx` این فایل را import می‌کند

## 🌐 نقشهٔ وابستگی‌ها
فایل جدید `src/test/EngagementNudge.test.jsx` بدون companion.
...
1. بررسی کن فایل `src/test/EngagementNudge.test.jsx` به چه companion ای نیاز دارد و آن را ایجاد یا متصل کن.
