---
task_id: 2d374782-2198-403f-8db4-97615e7b101d
title: event critical 'task_failed' هیچ notification ندارد
...
created_at: '2026-06-12T19:18:44.855100+00:00'
updated_at: '2026-06-12T19:34:45.295683+00:00'
---

# event critical 'task_failed' هیچ notification ندارد
...
## 🔍 جزئیات
- علت: event critical 'task_failed' هیچ notification ندارد
- پیشنهاد: اضافه کردن notify_event برای 'task_failed' در failure handler مربوطه
---
[scan #2 at 2026-06-12T19:18:45.515116+00:00]
## 📋 شرح (severity: high)
...
---
[scan #3 at 2026-06-12T19:18:45.844275+00:00]
## 📋 شرح (severity: high)
...
- [ ] `notify_event("task_failed", ...)` call در نقطه وقوع اضافه شد
...
1. گام ۱: محل وقوع `task_failed` در کد را پیدا کن.
گام ۲: `notification_service.notify_event("task_failed", message, silent=False, priority="high", ...)` اضافه کن.
...
1. `notify_event("task_failed", ...)` call در نقطه وقوع اضافه شد _(verify: static)_
