...
updated_at: '2026-05-29T18:42:43.176842+00:00'
target_files:
- src/App.jsx
---
...
1. با کلیک روی دکمه آپلود فایل اکسل، کتابخانه XLSX از CDN لود شود و پیام 'در حال بارگذاری' نمایش داده شود.
2. پس از لود، فایل اکسل بدون خطا پردازش شود.
3. دکمه میکروفون در رابط کاربری ظاهر شود و با کلیک، مرورگر درخواست دسترسی به میکروفون کند.
4. پس از تشخیص گفتار، متن تشخیص داده شده در فیلد مربوطه نمایش داده شود.
