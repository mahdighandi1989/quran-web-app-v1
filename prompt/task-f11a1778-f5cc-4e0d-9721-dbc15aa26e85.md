...
updated_at: '2026-06-12T19:14:39.050215+00:00'
target_files:
- src/lib/firebase.js
---
...
1. Firebase Analytics با `VITE_FIREBASE_MEASUREMENT_ID` به درستی مقداردهی اولیه شود.
2. رویدادهای `trackInteraction` به Firebase Analytics ارسال شوند.
3. تست واحد یا E2E برای تأیید ارسال رویدادهای تحلیلی به GA4 اضافه شود (با mock کردن Firebase Analytics).
