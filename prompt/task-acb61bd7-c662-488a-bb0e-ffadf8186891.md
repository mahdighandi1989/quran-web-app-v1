---
task_id: acb61bd7-c662-488a-bb0e-ffadf8186891
title: 🆕 فایل جدید `__init__.py` به هیچ‌جا متصل نیست (orphan)
...
created_at: '2026-06-12T19:23:09.512510+00:00'
updated_at: '2026-06-12T19:40:05.920145+00:00'
target_files:
- backend/app/tasks/__init__.py
---

# 🆕 فایل جدید `__init__.py` به هیچ‌جا متصل نیست (orphan)
...
## 🔍 جزئیات
- 📂 added: `backend/app/tasks/__init__.py`
- 🔥 risk: **medium**
...
---
[scan #2 at 2026-06-12T19:23:11.707758+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `tests/unit/test_ai_tasks.py`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
فایل orph
---
[scan #3 at 2026-06-12T19:23:12.070319+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `tests/backend/data_pipeline/test_integration.py`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
## 🌐 نقشهٔ وابستگی‌ها
فایل جدید `backend/app/tasks/__init__.py` بدون companion.
...
1. بررسی کن فایل `backend/app/tasks/__init__.py` به چه companion ای نیاز دارد و آن را ایجاد یا متصل کن.

## 📤 خروجی مورد انتظار
تغییر کد در فایل‌های مرتبط، commit یا PR جدید با پیام واضح، و عبور تمام معیارهای پذیرش.

## 🧪 دستورات اعتبارسنجی
- `python -m py_compile backend/app/tasks/__init__.py`
- `ruff check backend/app/tasks/__init__.py`
- `pytest -x`
