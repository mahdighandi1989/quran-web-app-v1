...
updated_at: '2026-06-05T18:43:58.170170+00:00'
target_files:
- src/lib/drive.js
---
...
1. driveDownload پس از دریافت پاسخ، validateDrivePayload را صدا می‌زند
2. اگر payload یک primitive باشد (مثلاً عدد 12345)، خطای 'payload نامعتبر' پرتاب می‌کند
3. اگر JSON قابل parse نباشد، خطای 'فایل قابل تجزیه نیست' پرتاب می‌کند
4. تست‌های موجود در App.test.jsx پاس می‌شوند
