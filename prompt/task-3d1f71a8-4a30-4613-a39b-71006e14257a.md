...
updated_at: '2026-06-12T19:19:54.113289+00:00'
target_files:
...
1. تابع `pickAyahs` از یک الگوریتم shuffling از نظر آماری صحیح استفاده می‌کند.
2. آزمون‌های تولید شده توزیع یکنواخت‌تری از انتخاب آیات را نشان می‌دهند.
3. تست‌های موجود برای `AIExamGenerator` (در صورت وجود) همچنان با موفقیت اجرا می‌شوند.
