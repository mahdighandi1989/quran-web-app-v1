---
task_id: 9457d15a-d682-4d71-a81d-67d9f93aa15e
title: اتصال یا حذف `test_vite_config.py`
...
created_at: '2026-06-05T18:47:12.326134+00:00'
updated_at: '2026-06-12T19:23:12.075310+00:00'
target_files:
- tests/system/test_vite_config.py
---

# اتصال یا حذف `test_vite_config.py`
...
## 🔍 جزئیات
- 📂 added: `tests/system/test_vite_config.py`
- 🔥 risk: **medium**
...
---
[scan #2 at 2026-06-05T18:47:12.379430+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `tests/test_git_ignore.py`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
فایل orphan 
---
[scan #3 at 2026-06-05T18:47:12.527267+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `tests/test_inspector_bridge.py`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
فایل o
---
[scan #4 at 2026-06-12T19:23:10.240800+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `tests/frontend/test_websocket_connection.py`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.

## 🤔 چرا م
---
[scan #5 at 2026-06-12T19:23:11.355147+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `tests/e2e/test_ai_conversation_initiation.py`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.

## 🤔 چرا 
---
[scan #6 at 2026-06-12T19:23:12.075305+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `tests/test_aiProviders.py`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
🆕 فایل جدید `test_vite_config.py` به هیچ‌جا متصل نیست (orphan)
...
## 🌐 نقشهٔ وابستگی‌ها
فایل جدید `tests/system/test_vite_config.py` بدون companion.
...
1. بررسی کن فایل `tests/system/test_vite_config.py` به چه companion ای نیاز دارد و آن را ایجاد یا متصل کن.

## 📤 خروجی مورد انتظار
تغییر کد در فایل‌های مرتبط، commit یا PR جدید با پیام واضح، و عبور تمام معیارهای پذیرش.

## 🧪 دستورات اعتبارسنجی
- `python -m py_compile tests/system/test_vite_config.py`
- `ruff check tests/system/test_vite_config.py`
- `pytest -x`
