---
task_id: e51ad6a2-440a-4ff3-a20f-add81484bbcd
title: 🆕 فایل جدید `vitest.config.js` به هیچ‌جا متصل نیست (orphan)
...
created_at: '2026-06-05T18:47:12.277719+00:00'
...
---
[scan #2 at 2026-06-05T18:47:12.603550+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.
...
2. wiring اضافه شد یا فایل حذف شد _(verify: manual_only)_
3. scan بعدی این فایل را orphan گزارش نمی‌کند _(verify: manual_only)_
