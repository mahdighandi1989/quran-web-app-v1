---
task_id: 173fd615-c79d-4dea-bc4b-5214a7827daa
title: تکمیل ساختار 604 صفحه قرآن
type: bug
priority: high
...
created_at: '2026-05-29T18:42:27.394779+00:00'
...
1. فایل src/data/quranPages.json شامل تمام 604 صفحه قرآن باشد _(verify: static)_
2. هر صفحه شامل surahها و ayahهای صحیح باشد _(verify: static)_
3. برنامه بعد از جایگزینی بدون خطا کار کند _(verify: ui_interaction)_
4. تمام صفحات قابل مرور باشند _(verify: ui_interaction)_
