---
task_id: ae5a1a65-d1d8-4669-9f27-4470bb2b9baa
title: پیاده‌سازی React Router برای مدیریت مسیرها
...
created_at: '2026-05-29T18:42:43.223559+00:00'
...
# پیاده‌سازی React Router برای مدیریت مسیرها
...
1. react-router-dom در package.json اضافه شود _(verify: static)_
2. حداقل 4 مسیر (routes) تعریف شود: /, /practice, /hifz, /settings _(verify: static)_
3. URL با navigation به روز شود _(verify: ui_interaction)_
4. قابلیت بازگشت با دکمه Back مرورگر کار کند _(verify: ui_interaction)_
5. برنامه build و run شود _(verify: ui_interaction)_
