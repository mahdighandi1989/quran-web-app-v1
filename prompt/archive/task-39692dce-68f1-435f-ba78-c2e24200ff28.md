---
task_id: 39692dce-68f1-435f-ba78-c2e24200ff28
title: پیکربندی .gitignore برای نادیده گرفتن فایل‌های حساس
type: security
priority: high
...
created_at: '2026-05-29T18:42:43.187953+00:00'
...
# پیکربندی .gitignore برای نادیده گرفتن فایل‌های حساس
...
1. الگوهای امنیتی به .gitignore اضافه شوند _(verify: static)_
2. فایل‌های env و credentials از git ignore شوند _(verify: backend_test)_
