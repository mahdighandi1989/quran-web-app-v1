---
task_id: a3e9a63e-155a-42ee-8566-56f81c55702e
title: ایجاد تست رندر برای main.jsx
type: other
priority: high
...
created_at: '2026-05-29T18:42:43.192287+00:00'
...
1. فایل src/main.test.jsx ایجاد شود _(verify: static)_
2. تست بررسی کند که رندر App بدون خطا انجام می‌شود _(verify: backend_test)_
3. تست با npm test عبور کند _(verify: backend_test)_
