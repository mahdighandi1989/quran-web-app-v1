---
task_id: 0740d77f-162f-4a75-a23b-bd9482f31b0e
title: ایجاد .gitignore مناسب برای React + Vite
type: other
priority: medium
...
created_at: '2026-05-29T18:42:43.243585+00:00'
...
# ایجاد .gitignore مناسب برای React + Vite
...
1. فایل .gitignore شامل node_modules, dist, .env باشد _(verify: static)_
2. فایل‌های غیرضروری در git status نمایش داده نشوند _(verify: backend_test)_
