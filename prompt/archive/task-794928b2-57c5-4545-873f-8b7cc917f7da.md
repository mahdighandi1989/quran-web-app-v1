---
task_id: 794928b2-57c5-4545-873f-8b7cc917f7da
title: ایجاد فایل .env.example و مستندسازی متغیرها
type: docs
priority: medium
...
created_at: '2026-05-29T18:42:43.230287+00:00'
updated_at: '2026-06-05T04:30:38.049448+00:00'
archived: true
archived_at: '2026-06-05T04:30:31.950267+00:00'
target_files:
- .env.example
---
...
در پروژه هیچ فایل .env.example وجود ندارد که متغیرهای محیطی مورد نیاز را مستند کند. با توجه به اینکه Firebase config باید به متغیرهای محیطی منتقل شود (یافته قبلی)، نیاز به یک فایل .env.example ضروری است. همچنین ممکن است متغیرهای محیطی دیگری در آینده اضافه شوند. عدم وجود این فایل باعث سردرگمی توسعه‌دهندگان جدید و افزایش خطر commit کردن اطلاعات حساس می‌شود.
...
عدم وجود فایل .env.example و مستندسازی متغیرهای محیطی

## 📍 موقعیت دقیق در پروژه
_(file:line — symbol — snippet)_

- `.env.example:1-10` — `N/A` — فایل جدید باید ایجاد شود
  ```
...
- `src/App.jsx` (سطر 12) — محل استفاده از متغیرهای محیطی

## 🌐 نقشهٔ وابستگی‌ها
فقط فایل‌های پیکربندی تحت تأثیر قرار می‌گیرند.
...
- [ ] فایل .env.example در ریشه پروژه وجود داشته باشد
- [ ] تمام متغیرهای محیطی مورد نیاز در آن ذکر شده باشند
- [ ] .env در .gitignore اضافه شده باشد
- [ ] هیچ تستی fail نمی‌شود (`npm run test` / `pytest`)
- [ ] linter بدون warning عبور می‌کند
- [ ] type-check موفق است (`tsc --noEmit` / `mypy`)

## 🪜 مراحل اجرایی پیشنهادی
1. یک فایل .env.example در ریشه پروژه ایجاد کنید که شامل تمام متغیرهای محیطی مورد نیاز با مقادیر placeholder باشد. همچنین مطمئن شوید .env در .gitignore اضافه شده است.
...
بدون این فایل، توسعه‌دهندگان جدید ممکن است متغیرهای محیطی را نادیده بگیرند.
...
1. فایل .env.example در ریشه پروژه وجود داشته باشد _(verify: static)_
2. تمام متغیرهای محیطی مورد نیاز در آن ذکر شده باشند _(verify: static)_
3. .env در .gitignore اضافه شده باشد _(verify: static)_
