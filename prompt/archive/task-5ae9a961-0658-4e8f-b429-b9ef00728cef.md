---
task_id: 5ae9a961-0658-4e8f-b429-b9ef00728cef
title: Fix stale assumption anti-pattern
type: bug_fix
priority: high
...
created_at: '2026-06-05T18:43:58.220011+00:00'
...
# Fix stale assumption anti-pattern
...
---
[scan #2 at 2026-06-05T18:43:58.234159+00:00]
در تابع `validateProviderKey`، اگر فراخوانی API برای دریافت مدل‌ها لیست خالی برگرداند (یا برای Anthropic که لیست مدل زنده را دریافت نمی‌کند)، تابع به `provider.models || []` بازمی‌گردد. از آنجایی که `provider.models` (از `BUILTIN_PROVIDERS`) احتمالاً منسوخ است (طبق مشکل قبلی)، این بدان معناست که تاب
