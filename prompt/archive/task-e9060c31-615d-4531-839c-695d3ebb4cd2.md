---
task_id: e9060c31-615d-4531-839c-695d3ebb4cd2
title: اتصال یا حذف `appStateStore.test.js`
...
created_at: '2026-06-05T18:47:12.408982+00:00'
...
# اتصال یا حذف `appStateStore.test.js`
...
---
[scan #2 at 2026-06-05T18:47:12.501765+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `src/test/setup.js`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
فایل orphan معمولاً
---
[scan #3 at 2026-06-05T18:47:12.553612+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `src/test/firebaseConfig.test.js`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
فایل 
---
[scan #4 at 2026-06-05T18:47:12.706947+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `src/test/aiStore.test.js`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
