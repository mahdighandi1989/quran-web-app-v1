---
task_id: f1e5bc0f-9e12-4b32-8aeb-66a3ac35e9c5
title: حذف @testing-library/user-event بلااستفاده
type: cleanup
priority: medium
...
# حذف @testing-library/user-event بلااستفاده
...
---
[scan #2 at 2026-06-05T18:46:35.220083+00:00]
## 📋 شرح
package `@testing-library/vue` در `` declare شده ولی در هیچ import کدبیس مصرف نمی‌شود.

## 🤔 چرا مهم است
dependency بلااستفاده باعث: (۱) bundle size بزرگ، (۲) attack surface بیشتر برای vulnerabilities، (۳) supply chain risk.

## 🔍 جزئیات
- نام package: `@testing-library/vue`
- زبان: `node`

---
[scan #3 at 2026-06-05T18:46:35.238591+00:00]
## 📋 شرح
package `@vitest/ui` در `` declare شده ولی در هیچ import کدبیس مصرف نمی‌شود.

## 🤔 چرا مهم است
dependency بلااستفاده باعث: (۱) bundle size بزرگ، (۲) attack surface بیشتر برای vulnerabilities، (۳) supply chain risk.

## 🔍 جزئیات
- نام package: `@vitest/ui`
- زبان: `node`
- علت: in package.js
---
[scan #4 at 2026-06-05T18:46:35.257046+00:00]
## 📋 شرح
package `firebase-admin` در `` declare شده ولی در هیچ import کدبیس مصرف نمی‌شود.

## 🤔 چرا مهم است
dependency بلااستفاده باعث: (۱) bundle size بزرگ، (۲) attack surface بیشتر برای vulnerabilities، (۳) supply chain risk.

## 🔍 جزئیات
- نام package: `firebase-admin`
- زبان: `node`
- علت: in pa
---
[scan #5 at 2026-06-05T18:46:35.275225+00:00]
## 📋 شرح
package `jsdom` در `` declare شده ولی در هیچ import کدبیس مصرف نمی‌شود.
...
- نام package: `jsdom`
- زبان: `node`
- علت: in package.json but no 
---
[scan #6 at 2026-06-05T18:46:35.293801+00:00]
## 📋 شرح
package `quran-meta` در `` declare شده ولی در هیچ import کدبیس مصرف نمی‌شود.

## 🤔 چرا مهم است
dependency بلااستفاده باعث: (۱) bundle size بزرگ، (۲) attack surface بیشتر برای vulnerabilities، (۳) supply chain risk.

## 🔍 جزئیات
- نام package: `quran-meta`
- زبان: `node`
- علت: in package.js
