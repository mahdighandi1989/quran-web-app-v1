...
updated_at: '2026-05-29T18:42:43.192290+00:00'
target_files:
- src/main.jsx
---
...
1. فایل src/main.test.jsx ایجاد شود
2. تست بررسی کند که رندر App بدون خطا انجام می‌شود
3. تست با npm test عبور کند
