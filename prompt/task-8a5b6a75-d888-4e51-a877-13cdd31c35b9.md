---
task_id: 8a5b6a75-d888-4e51-a877-13cdd31c35b9
title: notification بدون event_type صریح در scan_failure_handler.py
...
created_at: '2026-06-12T19:23:02.129483+00:00'
updated_at: '2026-06-12T19:23:02.129485+00:00'
target_files:
- backend/app/handlers/scan_failure_handler.py
---

# notification بدون event_type صریح در scan_failure_handler.py

## Raw Idea

## 📋 شرح
در `backend/app/handlers/scan_failure_handler.py` یک `notify_event` call پیدا شد که اولین پارامتر (event_type) رشته‌ای ساده/مبهم است یا خالی.
...
- `backend/app/handlers/scan_failure_handler.py:37`
...
- `backend/app/notification_pipeline.py` — `scan_failure_handler.py` این فایل را import می‌کند
...
## 🧪 دستورات اعتبارسنجی
- `python -m py_compile backend/app/handlers/scan_failure_handler.py`
- `ruff check backend/app/handlers/scan_failure_handler.py`
- `pytest -x`
...
1. event_type معنادار snake_case تعیین شد
2. در event registry ثبت شد
3. از UI tab notification settings این event قابل toggle است
