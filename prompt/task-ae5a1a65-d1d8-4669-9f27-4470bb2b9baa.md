...
updated_at: '2026-05-29T18:42:43.223562+00:00'
target_files:
- package.json
---
...
1. react-router-dom در package.json اضافه شود
2. حداقل 4 مسیر (routes) تعریف شود: /, /practice, /hifz, /settings
3. URL با navigation به روز شود
4. قابلیت بازگشت با دکمه Back مرورگر کار کند
5. برنامه build و run شود
