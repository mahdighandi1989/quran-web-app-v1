---
task_id: 52cc5842-d3fd-44ed-b9fa-879b9da877a8
title: notification بدون event_type صریح در scan_tasks.py
...
created_at: '2026-06-12T19:23:03.175219+00:00'
updated_at: '2026-06-12T19:23:03.175221+00:00'
target_files:
- backend/app/tasks/scan_tasks.py
---

# notification بدون event_type صریح در scan_tasks.py

## Raw Idea

## 📋 شرح
در `backend/app/tasks/scan_tasks.py` یک `notify_event` call پیدا شد که اولین پارامتر (event_type) رشته‌ای ساده/مبهم است یا خالی.
...
- `backend/app/tasks/scan_tasks.py:46`
...
## 🧪 دستورات اعتبارسنجی
- `python -m py_compile backend/app/tasks/scan_tasks.py`
- `ruff check backend/app/tasks/scan_tasks.py`
- `pytest -x`
