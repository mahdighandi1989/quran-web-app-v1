...
updated_at: '2026-06-12T19:23:13.614735+00:00'
target_files:
...
1. option `pid` label واضح فارسی/انگلیسی دارد
2. tooltip یا help text توضیح می‌دهد چه کاری می‌کند
3. default value منطقی + در README مستند شده
