---
task_id: 9f71e024-b32e-4031-b0df-7c0b76f0ed73
title: notification بدون event_type صریح در test_notification_pipeline.py
...
created_at: '2026-06-12T19:23:03.521452+00:00'
updated_at: '2026-06-12T19:23:03.521454+00:00'
target_files:
- tests/integration/test_notification_pipeline.py
---

# notification بدون event_type صریح در test_notification_pipeline.py

## Raw Idea

## 📋 شرح
در `tests/integration/test_notification_pipeline.py` یک `notify_event` call پیدا شد که اولین پارامتر (event_type) رشته‌ای ساده/مبهم است یا خالی.
...
- `tests/integration/test_notification_pipeline.py:282`
...
- `backend/app/notification_pipeline.py` — `test_notification_pipeline.py` این فایل را import می‌کند
- `backend/app/handlers/scan_failure_handler.py` — `test_notification_pipeline.py` این فایل را import می‌کند
- `backend/app/tasks/scan_tasks.py` — `test_notification_pipeline.py` این فایل را import می‌کند
...
## 🧪 دستورات اعتبارسنجی
- `python -m py_compile tests/integration/test_notification_pipeline.py`
- `ruff check tests/integration/test_notification_pipeline.py`
- `pytest -x`
