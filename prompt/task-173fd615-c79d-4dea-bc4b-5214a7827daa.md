...
updated_at: '2026-05-29T18:42:27.394780+00:00'
target_files:
- src/App.jsx
---
...
1. فایل src/data/quranPages.json شامل تمام 604 صفحه قرآن باشد
2. هر صفحه شامل surahها و ayahهای صحیح باشد
3. برنامه بعد از جایگزینی بدون خطا کار کند
4. تمام صفحات قابل مرور باشند
