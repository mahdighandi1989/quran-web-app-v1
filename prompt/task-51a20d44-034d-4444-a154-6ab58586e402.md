---
task_id: 51a20d44-034d-4444-a154-6ab58586e402
title: عدم تطابق نام فایل‌های تست با ساختار پروژه
type: refactor
priority: medium
...
created_at: '2026-06-05T18:46:34.266645+00:00'
updated_at: '2026-06-06T05:09:04.929458+00:00'
---

# عدم تطابق نام فایل‌های تست با ساختار پروژه

## Raw Idea

فایل‌های تست در دو مکان مختلف قرار دارند: src/test/ و tests/. فایل‌های src/test/ با الگوی src/test/*.test.js و فایل‌های tests/ با الگوی tests/*.py هستند. این نشان می‌دهد که تست‌های Python (احتمالاً برای backend) و تست‌های JavaScript (برای
