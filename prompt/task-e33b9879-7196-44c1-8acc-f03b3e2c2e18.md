...
updated_at: '2026-06-12T19:08:52.919860+00:00'
target_files:
- server/ai-proxy.mjs
---
...
1. فایل `server/test/ai-proxy.test.mjs` ایجاد شود.
2. تست‌هایی برای تأیید اینکه درخواست‌ها به درستی به ارائه‌دهنده AI هدایت می‌شوند، اضافه شود.
3. تست‌هایی برای تأیید اینکه کلیدهای API در سمت کلاینت افشا نمی‌شوند، اضافه شود.
4. تست‌هایی برای مدیریت خطا در صورت عدم پاسخگویی ارائه‌دهنده AI یا خطاهای شبکه اضافه شود.
