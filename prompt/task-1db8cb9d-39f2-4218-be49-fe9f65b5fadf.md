---
task_id: 1db8cb9d-39f2-4218-be49-fe9f65b5fadf
title: 'dependency بلااستفاده: @vitest/ui (node)'
type: cleanup
priority: medium
...
- زبان: `node`
- علت: in package.json but no import for '@vitest/ui' found
---
[scan #2 at 2026-06-12T19:21:49.327279+00:00]
## 📋 شرح
...
- علت: in pa
---
[scan #3 at 2026-06-12T19:21:49.664485+00:00]
## 📋 شرح
...
---
[scan #4 at 2026-06-12T19:21:50.021766+00:00]
## 📋 شرح
...
- [ ] `@vitest/ui` در هیچ direct import مصرف نمی‌شود + هیچ transitive dep ای آن را require نمی‌کند
...
1. گام ۱: `npm/pip list --depth=0` و grep import روی `@vitest/ui`.
