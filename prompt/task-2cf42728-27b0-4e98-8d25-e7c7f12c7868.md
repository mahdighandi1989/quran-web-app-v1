...
updated_at: '2026-05-29T18:42:43.180487+00:00'
target_files:
- src/App.jsx
---
...
1. فایل App.jsx کمتر از 200 خط شود
2. هر ماژول جدید حداکثر 200 خط داشته باشد
3. برنامه بدون خطا اجرا شود و تمام قابلیت‌ها کار کنند
4. importهای جدید در App.jsx به درستی کار کنند
