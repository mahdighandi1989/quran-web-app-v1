...
updated_at: '2026-06-05T18:43:58.183841+00:00'
target_files:
- src/lib/firebase.js
---
...
1. catch block دیگر خالی نیست و خطا را با console.warn لاگ می‌کند
2. notifyCriticalEvent با event name 'analytics_init_failed' فراخوانی می‌شود
3. تست واحد جدید در src/test/firebaseConfig.test.js اضافه شود که catch block را با mock کردن getAnalytics تست کند
