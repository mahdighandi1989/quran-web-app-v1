...
updated_at: '2026-06-12T19:14:40.032929+00:00'
target_files:
- src/lib/quran.js
---
...
1. فایل `src/test/quran.test.js` ایجاد شود.
2. تست‌هایی برای توابع `getAyah`, `getSurah`, `getPage` اضافه شود.
3. تست‌هایی برای سناریوهای لبه (مانند شماره سوره/آیه نامعتبر) اضافه شود.
4. تست‌هایی برای اطمینان از صحت داده‌های بازگردانده شده اضافه شود.
