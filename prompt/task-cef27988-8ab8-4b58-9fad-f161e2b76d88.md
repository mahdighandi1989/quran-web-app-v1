...
updated_at: '2026-06-05T18:43:58.162448+00:00'
target_files:
...
1. تابع validateExamQuestions در aiTasks.js وجود دارد
2. اگر سوالی فاقد q یا choices باشد، خطای مشخص برمی‌گرداند
3. تست واحد برای validateExamQuestions اضافه شده
4. AIExamGenerator بعد از validation نامعتبر، خطا را به کاربر نشان می‌دهد نه crash
