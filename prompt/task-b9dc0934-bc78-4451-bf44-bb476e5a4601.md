...
updated_at: '2026-06-12T19:23:09.181558+00:00'
target_files:
- server/ai.mjs
---
...
1. بررسی شد `server/telegram-bot.mjs` چه API ای از `server/ai.mjs` می‌خواهد
2. اگر API در `server/ai.mjs` نیست، اضافه شد
