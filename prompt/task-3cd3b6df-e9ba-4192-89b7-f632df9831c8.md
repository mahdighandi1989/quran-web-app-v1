...
updated_at: '2026-06-12T19:11:44.046111+00:00'
target_files:
- package.json
---
...
1. `package.json` در دایرکتوری ریشه شامل اسکریپت‌های `test` و `test:watch` است.
2. دستورات `npm test` و `npm run test:watch` تست‌های Vitest را به درستی اجرا می‌کنند.
