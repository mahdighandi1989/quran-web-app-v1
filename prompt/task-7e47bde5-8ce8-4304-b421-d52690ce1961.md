...
updated_at: '2026-06-12T19:11:43.746108+00:00'
target_files:
...
1. `src/data/quranPages.json` شامل داده‌های کامل برای تمام ۶۰۴ صفحه قرآن است.
2. برنامه به درستی تمام ۶۰۴ صفحه را نمایش داده و بین آن‌ها ناوبری می‌کند.
3. تست‌های مرتبط (مانند `src/test/quranPages.test.js`) با موفقیت اجرا می‌شوند و کامل بودن و صحت ساختار صفحه را تأیید می‌کنند.
