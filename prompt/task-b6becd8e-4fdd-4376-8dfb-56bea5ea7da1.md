---
task_id: b6becd8e-4fdd-4376-8dfb-56bea5ea7da1
title: 🆕 فایل جدید `notificationScheduler.test.js` به هیچ‌جا متصل نیست (orphan)
...
# 🆕 فایل جدید `notificationScheduler.test.js` به هیچ‌جا متصل نیست (orphan)
...
## 🔍 جزئیات
- 📂 added: `src/test/notificationScheduler.test.js`
- 🔥 risk: **medium**
...
---
[scan #2 at 2026-06-12T19:23:10.607072+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `src/test/notificationCriticality.test.js`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.

## 🤔 چرا مهم 
---
[scan #3 at 2026-06-12T19:23:10.968873+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `src/test/notificationPipeline.test.js`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.

## 🤔 چرا مهم است
---
[scan #4 at 2026-06-12T19:23:11.349246+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `src/test/proactiveNotificationFormatter.test.js`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.

## 🤔 چ
---
[scan #5 at 2026-06-12T19:23:12.424005+00:00]
## 📋 شرح
این فایل تازه اضافه شده ولی هیچ فایلی آن را import نمی‌کند.

## 🔍 جزئیات
- 📂 added: `src/test/aiClientSecurity.test.js`
- 🔥 risk: **medium**
- 📝 reason: این فایل جدید اضافه شده ولی هیچ فایل دیگری آن را import نمی‌کند — احتمالاً wiring فراموش شده یا dead-on-arrival است.
...
- `src/lib/telegram.js` — `notificationScheduler.test.js` این فایل را import می‌کند

## 🌐 نقشهٔ وابستگی‌ها
فایل جدید `src/test/notificationScheduler.test.js` بدون companion.
...
1. بررسی کن فایل `src/test/notificationScheduler.test.js` به چه companion ای نیاز دارد و آن را ایجاد یا متصل کن.
