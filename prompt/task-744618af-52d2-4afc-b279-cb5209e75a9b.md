...
updated_at: '2026-06-12T19:19:53.786121+00:00'
target_files:
- src/App.test.jsx
---
...
1. تمام تست‌ها در `src/App.test.jsx` به طور پایدار و بدون تداخل حالت بین تست‌ها اجرا می‌شوند.
2. بلوک `describe('Firebase auth (firebase/auth mocked)')` شامل یک هوک `beforeEach` است که `vi.restoreAllMocks()` را فراخوانی می‌کند.
