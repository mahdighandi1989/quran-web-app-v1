...
updated_at: '2026-05-29T18:42:27.392845+00:00'
target_files:
- package.json
---
...
1. vitest و وابستگی‌های لازم در package.json اضافه شوند
2. فایل vitest.config.js ایجاد شود
3. اسکریپت npm test کار کند
4. حداقل یک تست ساده (مثلاً 1+1=2) با npm test عبور کند
5. فایل src/test/setup.js برای تنظیمات global ایجاد شود
