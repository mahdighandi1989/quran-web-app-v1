...
updated_at: '2026-06-12T19:08:52.625983+00:00'
target_files:
...
1. فایل `server/test/telegram-bot.test.mjs` ایجاد شود.
2. تست‌هایی برای پردازش دستور `/start` و `/status` اضافه شود.
3. تست‌هایی برای اعتبارسنجی توکن بات و تنظیم منوی بات اضافه شود.
4. تست‌هایی برای اطمینان از تعامل صحیح با Firestore (خواندن/نوشتن) اضافه شود.
5. تست‌هایی برای مدیریت خطا در فراخوانی‌های API تلگرام اضافه شود.
